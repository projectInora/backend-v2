...
use App\Repository\Fishing\FishingCenterRepository;
use Doctrine\DBAL\Types\Types;
use Doctrine\ORM\Mapping as ORM;
use function Symfony\Component\String\u;

#[ORM\Entity(repositoryClass: FishingCenterRepository::class)]
class FishingCenter extends BaseAddressRecord
{
    #[ORM\Id]
    #[ORM\GeneratedValue]
    #[ORM\Column]
    ...
    private ?AuthUser $masterAdmin = null;
    ...
    {
        parent::__construct();
        $this->uuid = strtoupper(uniqid("FSH_"));
    ...
    public function getMasterAdmin(): ?AuthUser
    {
        return $this->masterAdmin;
    }

    public function setMasterAdmin(?AuthUser $masterAdmin): static
    {
